...
Makefile.conf: _CoqProject
	/snap/coq-prover/28/coq-platform/2022-01-0/bin/coq_makefile COQBIN = /snap/coq-prover/28/coq-platform/2022-01-0/bin/ -f _CoqProject Automaton.v BaseDefinitions.v Tests.v -o Makefile
